			...
			<form class="form-horizontal" data-toggle="validator" method="post">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="nama" type="text" name="nama" autofocus="autofocus" placeholder="Nama Supplier" class="form-control" maxlength="100" required="required">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea placeholder="Alamat Kantor" id="alamat" name="alamat_kantor" class="form-control" required="required" style="resize: none;" rows="3"></textarea>
							<span class="help-block with-errors"></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="noTelp" type="text" name="noTelp" autofocus="autofocus" placeholder="No. Telp" class="form-control"  minlength="12" maxlength="12" required="required" onkeypress="return hanyaAngka(event)">
							<span class="help-block with-errors"></span>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input id="email" type="email" name="email" autofocus="autofocus" placeholder="E-mail" class="form-control" maxlength="100" required="required">
							<span class="help-block with-errors"></span>
						</div>
					</div>
