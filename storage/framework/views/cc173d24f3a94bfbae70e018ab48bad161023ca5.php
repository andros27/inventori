                    ...
                    <div class="row">
                            ...
                            <div class="team-member" data-animate="fadeInUp">
                                <div class="image">
                                    <a href="team-member.html">
                                        <img src="<?php echo e(asset('template2/img/person-1.jpg')); ?>" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                    <a href="team-member.html">
                                        <img src="<?php echo e(asset('template2/img/person-2.jpg')); ?>" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                    <a href="team-member.html">
                                        <img src="<?php echo e(asset('template2/img/person-3.png')); ?>" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-3" data-animate="fadeInUp">
                            <div class="team-member">
                                <div class="image">
                                    <a href="team-member.html">
                                        <img src="<?php echo e(asset('template2/img/person-4.jpg')); ?>" alt="" class="img-responsive img-circle">
                                    </a>
                                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="owl-carousel customers no-mb">
                            <li class="item">
                                <img src="<?php echo e(asset('template2/img/customer-1.png')); ?>" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo e(asset('template2/img/customer-2.png')); ?>" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo e(asset('template2/img/customer-3.png')); ?>" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo e(asset('template2/img/customer-4.png')); ?>" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo e(asset('template2/img/customer-5.png')); ?>" alt="" class="img-responsive">
                            </li>
                            <li class="item">
                                <img src="<?php echo e(asset('template2/img/customer-6.png')); ?>" alt="" class="img-responsive">
                            </li>
                        </ul>
                        <!-- /.owl-carousel -->
                    </div>
