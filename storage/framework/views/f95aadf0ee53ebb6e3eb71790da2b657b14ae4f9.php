                    ...
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand home" href="index.html">
                                <img src="<?php echo e(asset('template2/img/logo.png')); ?>" alt="Universal logo" class="hidden-xs hidden-sm">
                                <img src="<?php echo e(asset('template2/img/logo-small.png')); ?>" alt="Universal logo" class="visible-xs visible-sm"><span class="sr-only">Universal - go to homepage</span>
                            </a>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="<?php echo e(asset('template2/img/template-easy-customize.png')); ?>" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Shortcodes</h5>
                                                        <ul>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="yamm-content">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img src="<?php echo e(asset('template2/img/templatehomepage.png')); ?>" class="img-responsive hidden-xs" alt="">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <h5>Portfolio</h5>
                                                        <ul>
