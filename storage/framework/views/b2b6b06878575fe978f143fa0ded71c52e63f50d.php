...
<section class="forms">
	...
	<div class="col-lg-12">
		...
		<div class="card">
            ...
            <div class="card-body">
            	<form class="form-inline" action="<?php echo e(route('kategori.update', $kategori->id_kategori)); ?>" method="POST">
                    <?php echo e(csrf_field()); ?> <?php echo e(method_field('PATCH')); ?>
                 	...
                 	<div class="form-group">
                    	...
                    	<div class="col-lg-9">
                    		<input id="inlineFormInput" type="text" name="nama_kategori" autofocus="autofocus" placeholder="Ex. Besi" class="form-control" maxlength="100" value="<?php echo e($kategori->nama_kategori); ?>">	
                    	</div>
